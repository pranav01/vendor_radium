...
NOTIFICATION_PATH := vendor/radium/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/radium/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/radium/prebuilt/common/media/audio/ui
